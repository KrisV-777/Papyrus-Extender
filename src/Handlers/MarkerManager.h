#pragma once
	...
	public:
		...
		static inline RE::TESObjectREFR* GetLastMarker() { return _markers.count(_quest) ? _markers[_quest] : nullptr; }
		static inline RE::TESObjectREFR* GetQuestMarker(RE::TESQuest* a_quest) { return _markers.count(a_quest) ? _markers[a_quest] : nullptr; }
